#ifndef MACROCLI_INTERNAL_PARSE_H
#define MACROCLI_INTERNAL_PARSE_H
...
ParseResult macrocli_parse(char* input, const char** arguments, size_t max_arguments);

#endif // MACROCLI_INTERNAL_PARSE_H
